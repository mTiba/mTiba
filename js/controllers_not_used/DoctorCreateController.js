...
mtibaModule.controller('DoctorCreateController', function($scope, $http, $state, doctorMetadataFactory, doctorFormStepsFactory, Upload, $timeout, ngDialog, $stateParams, Doctor) {
