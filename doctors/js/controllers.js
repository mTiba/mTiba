angular.module('mtibaDoctors.controllers', [])
...
.controller('DoctorViewController', function($scope, $stateParams, Doctor, metadataFactory, $http, $state) {
...
.controller('DoctorCreateController', function($scope, $http, $state, metadataFactory, formStepsFactory, Upload, $timeout, ngDialog, $stateParams, Doctor) {
...
.controller('DoctorEditController', function($scope, $state, $stateParams, Doctor, metadataFactory, formStepsFactory) {
